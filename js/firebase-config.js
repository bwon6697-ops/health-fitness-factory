/**
 * HEALTH & FITNESS FACTORY - Central Configuration File
...
try {
    ...
    auth.setPersistence(firebase.auth.Auth.Persistence.LOCAL)
        .then(() => {
            console.log("✅ Login persistence enabled - users stay logged in");
        })
        .catch((error) => {
...
console.log("🚀 Health & Fitness Factory Config Loaded ✓");
